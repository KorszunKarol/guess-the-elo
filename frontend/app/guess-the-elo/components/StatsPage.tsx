...
import { Target, TrendingUp, Clock, Brain, ChevronLeft, Star } from "lucide-react"
...
function ModeStats({ stats, mode }: { stats: any, mode: 'guessTheElo' | 'guessTheEval' }) {
  const data = mode === 'guessTheElo'
    ? Object.entries(stats[mode].ratingDistribution).map(([key, value]) => ({
  ...
  return (
    <div className="space-y-4">
      ...
      {mode === 'guessTheElo' ? (
        <Card className="bg-[#1a1b1e] border-[#2a2b2d]">
          <CardHeader>
            <CardTitle className="text-gray-200">Rating Distribution</CardTitle>
          ...
          <CardContent className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data}>
                ...
                />
                <Tooltip
                  contentStyle={{ background: '#2a2b2d', border: 'none' }}
        ...
        <Card className="bg-[#1a1b1e] border-[#2a2b2d]">
          <CardHeader>
            <CardTitle className="text-gray-200">Position Type Accuracy</CardTitle>
            <CardDescription className="text-gray-400">
          ...
          <CardContent className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={[
                { category: 'Winning', accuracy: stats.guessTheEval.winningPositions },
                { category: 'Equal', accuracy: stats.guessTheEval.equalPositions },
                { category: 'Losing', accuracy: stats.guessTheEval.losingPositions },
              ]}>
                <XAxis
                  dataKey="category"
                  stroke="#888888"
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Tabs defaultValue="guessTheElo" className="space-y-6">
          <TabsList className="bg-[#1a1b1e] border-[#2a2b2d]">
            <TabsTrigger value="guessTheElo" className="data-[state=active]:bg-[#2a2b2d]">
              Guess the Elo
            </TabsTrigger>
            <TabsTrigger value="guessTheEval" className="data-[state=active]:bg-[#2a2b2d]">
              Guess the Eval
            </TabsTrigger>
          </TabsList>
