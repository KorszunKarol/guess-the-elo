...
export function SettingsModal({ isOpen, onClose, onSave, gameMode }: SettingsModalProps) {
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  step={1}
                  onValueChange={([value]) => {
                    setSettings(prev => ({ ...prev, openingBias: value }))
                  }}
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  step={1}
                  onValueChange={([value]) => {
                    setSettings(prev => ({ ...prev, middlegameBias: value }))
                  }}
                  className="cursor-pointer"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  step={1}
                  onValueChange={([value]) => {
                    setSettings(prev => ({ ...prev, endgameBias: value }))
                  }}
                  className="cursor-pointer"
                />
              </div>
