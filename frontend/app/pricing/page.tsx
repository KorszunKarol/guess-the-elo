      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            ...
            >
              <Card className={`relative h-full bg-gray-800 border-gray-700 ${
                    ...
                    {plan.limitations && (
                      <div className="pt-3 border-t border-gray-700">
                        {plan.limitations.map((limitation) => (
                          <div key={limitation} className="flex items-center text-gray-400">
        ...
        >
          ...
          <p className="mt-2">Have questions? <a href="#" className="text-blue-400 hover:underline">Contact us</a></p>
        </motion.div>
      </div>
    </div>
  );
