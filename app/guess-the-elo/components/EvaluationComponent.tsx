...
function EvaluationComponent({ onSubmit, turn, highScore, round }: EvaluationComponentProps) {
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <span className="text-base font-medium text-gray-200">Turn:</span>
            <span className={`text-base font-bold ${turn === "White" ? "text-yellow-200" : "text-gray-800"}`}>
              {turn}
            </span>
          </div>
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-medium text-gray-300">Your Evaluation:</span>
          ...
          <div className="flex justify-between items-center">
            ...
            <div>
              ...
              <span className="ml-2 text-base font-bold text-blue-400">{round}/5</span>
            </div>
          </div>
          <div>
            <Button
            ...
            {showHint && (
              ...
              >
                Look for piece positioning, control of the center, and pawn structure to help gauge the skill level.
              </motion.div>
            )}
          </div>
        </div>
